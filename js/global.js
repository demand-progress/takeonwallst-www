...
Thanks!";
    ...
    // var $prompt = $('.prompt');
    //
    // var email = 'ChrisAntaki@';
    // var key = '011879d43dfe95dd96283030ca383e252d59c3fd414f945695dcda0fdce55b0f';
    // var name = 'Chris Antaki';
    // var petition_id = '2128396';
    // var url = 'https://dp-wethepeople.herokuapp.com/api/v1/sign?callback=?';
    //
    // $prompt.text('Sending request');
    // $.getJSON(url, {
    //     email: email,
    //     key: key,
    //     name: name,
    ...
    // }, function(res) {
    //     $prompt.text(JSON.stringify(res));
    // });
